  ...
  return (
    <>
      ...
      <div className="bg-gray-50 mx-5 mt-8 py-8 px-5 rounded-lg">
        ...
        {/* Quantity */}
        <div className="quantity leading-10 mt-4">
          <h3 className="font-bold">Quantity</h3>
          <div className="flex items-center py-2 space-x-5 border-2 border-gray-300 w-32 rounded-md">
            <button
              className="text-3xl cursor-pointer hover:text-blue-500 px-3"
            ...
            <button
              className="text-2xl cursor-pointer hover:text-blue-500 px-3"
        ...
        {/* Add to Cart */}
        <button
          className="bg-blue-500 w-full py-4 mt-6 font-bold text-white rounded-md hover:bg-blue-600 flex items-center justify-center gap-3"
          onClick={() => addToCart({productId: product._id, quantity, size: selectedSize})}
        >
